- Def = Ensemble de lois, gvt, mobil, politiques éco, constituition, présidence
- Ass. nat°ale : lieu de démocratie, discu°, hiérarchie
- Guernica = dénonce les bombardements pdt guerre civile car picasso = figure reconnue, > ampleur du msg
- "l'ensemble des efforts faits pr particip au pv / l'influencer, la répart du pv, -> entre les états / diff grp au sein d'un état" (MAX WEBER)
- Politique diff LA Politique :  Pas de mobil, pas de  détention du pv
	- LA politique = institutions (gvt, état, élections, partis)
	- LE politique = + large, formes émergentes / innovantes, + institutionnakité (Haegel)
		- Ex : se déplacer en vélo = 
			- dim éco : - cher
			- dim sociale = classe sociale
			- politique : peut etre politisé dans les débats
		- Autres ex de politisé : 
			- Manger certains pdts, suivre un certain régime
			- Sécu routière: interdiction de rouler alcoolisé, port de ceinture obligatoire > régulé
			- Avortement : gisèle halimi, via plaidoyer + mobilisations, Simone de beauvoir via manifeste de l'avortement
			- Tabac avec hausse des prix

Il y a politisation quand : 
- Demande de régil / modif d'une règle / loi. Devient politique qd pris en charge par acteurs politiques / pv politique.
- affrontements ds sphère publique (médiatisation)
	- Q de la canicule
	- politisation de l'art (ex mafalda)

/!\ A RETENIR : 
- Le terme politique = polysystémique
- dist LE / LA politique
	- LA = compet pr le pv / influ sur le pv
	- LE = politisation de la vie sociale

### Politics, policy, polity
POLITICS = Ensemble des luttes entre les acteurs de la décision politique socio électorale

POLITY = idée de s'intéresser à la chose politique, cmt le vivre ensemble est orga par l'état
Qui gouv, cmt R sont distrib, =/= régimes démoc / politiques

POLICY = cmt le gvt peut il agir pr améliorer les choses ?
prépa les réformes 
-> prog d'actions du gvt (de l'état)
ex: nutriscore, interdiction pesticides, zones protégées... contraception ; Les 3 :
politics : soutenu par certains partis
polity : âge max de remboursement
policy : l'état agit pr rembourser

## Chapitre 1 - Etat et Pv Politique
### 1. Qu'est ce que le pv politique ?
#### 1.1 Defs
- **<u>Pouvoir</u>**
	- Capacité d'une pers A de contraindre une pers B à faire quelque chose qu'elle n'aurait pas faite sans l'intervention de la pers A. = Cap à imposer sa volonté
		- entre des pers / grp sociaux
- <u>Pouvoir d'injonction / coercition</u>
	- Capacité à imposer des sanctions négatives pour obtenir obéissance et soumission.
		- = Cap d'imposer sa volonté, y compris par la force, dans une sit où il n'y a pas de légitimité du pv ou bien qu'elle est inssufisante.
- <u>Le pv d'influence / autorité</u>
	- Obtenir la soumission sans recours à la force
- <u>Autorité</u> 
	- Forme de confiance, de légitimité, de respect, est consenti

#### 1.2 Les types de domination légitimes
- Légitimité trad
- Legit charismatique
- Legit légale-rationnelle
...
Ex: chine avec les mandarins (hauts fonctionnaires sélectionnés par concours, envoyés très loin de chez eux pr se déconnecter de leur relation et pleinement exercer leur fonction)
**Roi a deux coprs : un biologique et un symbolique**
Le roi symbolique ne meurt jamais
