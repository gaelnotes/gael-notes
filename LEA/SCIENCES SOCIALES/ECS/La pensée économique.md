## I. Introduction - l'histoire de la pensée économique
<u>Il existe différents courants :</u> 
- Le courant libéral
- le courant keynésien
- le courant marxiste
- Les courants classiques et néoclassiques
Chaque courant a interprêté le comportement des agents économiques d'une manière différente : 
- Certains privilégient le marche et favorisent l'économie de marché
- D'autres privilégient l'économie de l'état
3 Questions se posent : 
-Comment l'éco pdt elle et répartit elle les richesses ?
-Le marché peut il se réguler seul / s'auto réguler ?
-Quel est le rôle de l'état ?
### 1. Le courant libéral
Def = économie du marché "libre" (détenir les ressources + faire des investussements) => propriété privée des facteurs de prod
éco marché diff éco état: pas d'équilibre du marché, l'état n'intervient pas pour réguler

### 2. Le courant marxiste
Def = l'état détient les facteurs  de prod (opposé du CL) => économie de l'état -> propriété collective

### 3. Le courant keynésien
Def = libéralisme avec l'intervention de l'état

## I.a Les différents agents économiques
- Le conso / ménages (LA DEMANDE)
	- Un conso rationnel cherche à maximiser son utilité (satisf ss contraintes de budget limité -> px le + faible possible)
- L'E / le Prod / Investisseurs (L'OFFRE)
	- maximiser ses profits
- L'état
	- Maximiser les recettes publiques / diminuer les dépenses publiques

## I.b les diff types d'éco
- Eco fermée = 3 agents
...
=>gest des R de la cité puis de la nation
=>éco étud chx avec R limit
=> cherche à comprendre prod + répart util / richesses
economiser = orga les ressources
/!\ A RETENIR : Eco = science sociale soit étude du comp humain, ne f() pas comme science exacte

>ECONOMISTES
>ADAM SMITH (1723-1790)
>-eco = science de la richesse
>-anal prod / distrib / accumula°
>-division du travail, aug de la productivité
>
>RAYMOND BARRE (1924-2007)
>-eco = admin R rares
>-besoins nombreux mais R limit
>-chx > arbitrages
>
>PAUL SAMUELSON (1915-2009)
>-société -> employer R rares
>-les R permettent de prod des biens / services
>-la Q de leur répart est centrale
>=>Rareté > chx >prod >répart = Panier optimal

- Chaque conso a un panier de consomma° -> contient qtt opti biens en f()budget
- Chaque prod déter combi opti de facteurs de prod : K=> profit max

### Les PB fondamentaux

- Quoi prod?
	- Quels B/S privilégier ?
- Cmt prod
	- avec quelles techs / travailleurs / R
- Pr qui prod
	- cmt richesses / revenus sont répart ?
=> Ces 3 Q existent ds toutes les eco mais les rep diff en f() des institu° / chx politiques

- Micro eco = comportement des  agents à petite échelle (nationale max)
	- conso : chx ss contrainte de revenus
	- prod : couts, prod, profits
	- marché offre demande px
- Méso éco
	- entre les 2 
	- anal secteur / branche d'activité
	- ex automobile, tourisme, énergie...
- Macro éco = ensemble des facteurs impactant l'éco globale de la nation (échelle nation / international)
	- anal éco dans son ensemble
	- varie selon infla°, chomage, greve
	- anal conso / invest, commerce
	- etude politique, budgetaire, monétaire
			- PB ECO : infla°, taxes, croissance éco

## 1. Le courant classique

- ADAM SMITH
	- main invisible joue avec l'élasticité de l'offre et de la demande*
	- divis travail, aug productivité
	- marché = role centrale ds alloc R 
- DAVID RICARDO
	- les avt comparatifs
	- le commerce peut etre diff entre les pays, inégalités au niveau de la prod
	- défend le libre échange
- JEAN BAPTISTE SAY
	- prod -> distrib revenus
	- offre crée sa propre demande, réserve loi des débouchés
	- crise générale de surprod = improbable

## 1.2 Le courant Néoclassique
=Prolongement du CL à la fin du 19eme
5 individus ra°els qui arbitrent * chx
